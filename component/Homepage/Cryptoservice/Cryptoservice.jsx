                        ...
                        <div className="col-lg-6">
                            <div className="dreamit-section-title two pb-20">
                                <div className="dreamit-section-sub-title">
                                    <h5> <img src="assets/images/new/title-img.png" alt="" /> Trading Platform</h5>
                                </div>
                                <div className="dreamit-section-main-title">
                                    <h1>We complete every project <br />extra care as customer.</h1>
                                </div>
                                <div className="dreamit-section-content-text">
                                    <p>Globally transition ours multidisciplinary applications for bleeding-edge vortals.
                                        harness  o ours plug-and-plays networks without stand-alone bandwidth market
                                        harness competitive channels.</p>
                                </div>
                                <div className="dreamit-content-text-inner">
                                    <p>Seamlessly redefine ethical materials through ours high-payoff growth strategie
                                        appropriately envisioneer robust infrastructures before robust for the
                                        aynergistically generate B2B alignments after.</p>
                                </div>
                                <div className="choose-btn">
                                    <a href="Javascript:void(0);"><i className="flaticon-plus"></i> Read More</a>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-6 col-md-6">
                            <div className="choose-thumb">
                                <img src="assets/images/new/single.png" alt="" />
                            </div>
