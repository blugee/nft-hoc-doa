...
import Breatcome from '../Breatcome/Breatcome';

const Roadmap = () => {
    return (
        <>
            <Breatcome pageName='Road Map' />
            {/* road map section- 1  */}
            <div className="road-map style-two pt-100 pb-50">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="dreamit-section-title-two text-center pb-20">
                                <div className="dreamit-section-main-title">
                                    <h1>Our Strategy <span>Roadmap</span></h1>
                                </div>
                                <div className="dreamit-section-content-text-inner">
                                    <p>Dynamically evisculate revolutionary technologies before authoritatively
                                        restore backward-compatible impact enterprise-wide</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row tooper pt-40">
                    ...
                    <div className="row tooper pt-40">
                        ...
                        <div className="shape16">
                            <img src="assets/images/map/road.png" alt="" />
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="row topper2 pt-100">
                        <div className="col-lg-12">
                            <div className="road-map-btn text-center">
                                <a href="Javascript:void(0);">View Full Road Map </a>
                            </div>
                        </div>
                    </div>
                    <div className="row upper5 align-items-center mt-90">
                        ...
                        <div className="col-lg-6 col-md-12">
                            ...
                            <div className="road-icon-btn">
                                <a href="Javascript:void(0);">Dounload <i className="flaticon-angle-arrow-down"></i></a>
                            </div>
                        </div>
                        <div className="col-lg-6 col-md-12">
