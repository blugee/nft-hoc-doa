                ...
                <div className="container">
                    <div className="row pt-50">
                        <div className="col-lg-4 col-md-6">
                            <div className="single-blog-grid-box">
                                <div className="blog-grid-thumb">
                                    <a href="Javascript:void(0);"><img src="assets/images/blog/blog4.jpg" alt="" /></a>
                                </div>
                                <div className="blog-grid-content">
                                    <div className="blog-grid-meta">
                                        <a href="Javascript:void(0);">21 Nov 2021</a>
                                        <span>By Admin</span>
                                    </div>
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="single-blog-grid-box">
                                <div className="blog-grid-thumb">
                                    <a href="Javascript:void(0);"><img src="assets/images/blog/blog3.jpg" alt="" /></a>
                                </div>
                                <div className="blog-grid-content">
                                    <div className="blog-grid-meta">
                                        <a href="Javascript:void(0);">21 Nov 2021</a>
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="single-blog-grid-box">
                                <div className="blog-grid-thumb">
                                    <a href="Javascript:void(0);"><img src="assets/images/blog/blog2.jpg" alt="" /></a>
                                </div>
                                <div className="blog-grid-content">
                                    <div className="blog-grid-meta">
                                        <a href="Javascript:void(0);">21 Nov 2021</a>
                        ...
                        <div className="col-lg-12">
                            <div className="pagination text-center">
                                <div className="page-number text-center pt-20">
                                    <ul>
                                        <li><a className="active" href="Javascript:void(0);">1</a></li>
